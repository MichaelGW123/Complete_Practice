...
class Rotate_CW : public QWidget
{
 public:
    Rotate_CW(QWidget *parent = nullptr)
        : QWidget(parent)
    {
        ...
        // connect(actionButton, &QPushButton::clicked, this, &Rotate_CW::selectFilePath);
        // connect(udpButton, &QPushButton::clicked, this, &Rotate_CW::sendViaUDP);
        // connect(tcpButton, &QPushButton::clicked, this, &Rotate_CW::sendViaTCP);
    }
...
int main(int argc, char *argv[])
{
    ...
    Rotate_CW sender; // take tcp and udp sockets, set member variables up for
