...
class Rotate_CCW : public QWidget
{
 public:
    Rotate_CCW(QWidget *parent = nullptr)
        : QWidget(parent)
    {
        ...
        // connect(actionButton, &QPushButton::clicked, this, &Rotate_CCW::selectFilePath);
        // connect(udpButton, &QPushButton::clicked, this, &Rotate_CCW::sendViaUDP);
        // connect(tcpButton, &QPushButton::clicked, this, &Rotate_CCW::sendViaTCP);
    }
...
int main(int argc, char *argv[])
{
    ...
    Rotate_CCW sender; // take tcp and udp sockets, set member variables up for
