...
class Flip_H : public QWidget
{
 public:
    Flip_H(QWidget *parent = nullptr)
        : QWidget(parent)
    {
        ...
        // connect(actionButton, &QPushButton::clicked, this, &Flip_H::selectFilePath);
        // connect(udpButton, &QPushButton::clicked, this, &Flip_H::sendViaUDP);
        // connect(tcpButton, &QPushButton::clicked, this, &Flip_H::sendViaTCP);
    }
...
int main(int argc, char *argv[])
{
    ...
    Flip_H sender; // take tcp and udp sockets, set member variables up for
